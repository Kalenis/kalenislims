...
def register():
    Pool.register(
        ...
        notebook.NotebookInitialConcentrationCalc2Result,
        notebook.NotebookInitialConcentrationCalc2Concentration,
        notebook.NotebookInitialConcentrationCalc2Variable,
        notebook.NotebookInitialConcentrationCalc2Process,
